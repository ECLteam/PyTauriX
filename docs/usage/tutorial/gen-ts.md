...
Since `v0.7`, pytaurix natively supports generating a TypeScript client for [Commands][pytaurix.Commands]. This makes calling pytaurix commands in TypeScript very simple and type-safe.

## Install Dependencies

pytaurix uses pydantic to generate jsonschema, then calls [json-schema-to-typescript] to convert it into TypeScript type definitions.
...
[Commands.experimental_gen_ts_background][pytaurix.ipc.Commands.experimental_gen_ts_background]

```python title="src-tauri/python/tauri_app/__init__.py"
--8<-- "docs/snippets/tutorial/gen_ts.py"
```
...
/* eslint-disable */
/**
 * This file was automatically generated by pytaurix-gen-ts.
 * DO NOT MODIFY IT BY HAND. Instead, modify the source commands API,
 * and run pytaurix-gen-ts to regenerate this file.
 */
...
[JavaScriptChannelId][pytaurix.ipc.JavaScriptChannelId] is serialized and deserialized as a `string` between the frontend and backend, so the generated ts type is `string`.
