...
- [#50](https://github.com/pytauri/pytauri/pull/50) - feat: add `class Channel extends TauriChannel<ArrayBuffer>` for pytaurix [channels ipc](https://tauri.app/develop/calling-frontend/#channels).
...
[0.8.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.8.0
[0.7.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.7.0
[0.6.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.6.0
[0.5.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.5.0
[0.4.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.4.0
[0.3.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.3.0
[0.2.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.2.0
[0.1.0-beta.0]: https://github.com/ECLteam/PyTauriX/releases/tag/js/@pytaurix/api/v0.1.0-beta.0
