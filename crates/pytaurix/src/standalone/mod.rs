//! Used for embedding Python in a standalone pytaurix application.
//!
...
impl PythonInterpreterEnv<'_> {
    ...
    fn set_path_for_config(self, config: &mut PyConfig) -> NewInterpreterResult<()> {
        ...
        // instead of the expected [`${APPDIR}/usr/lib/{your-app-name}/lib`](https://eclteam.github.io/PyTauriX/0.3/usage/tutorial/build-standalone/#unix_3).
    ...
    M: for<'py> FnOnce(Python<'py>) -> Py<PyModule> + 'a,
{
    ...
    use pytaurix::standalone::{PythonInterpreterBuilder, PythonInterpreterEnv, PythonScript};
    use std::path::Path;
...
/// occur.
///
/// If you use pyo3 APIs like [Python::attach()] directly, you may
...
impl PythonInterpreter {
    ...
    /// Proxy for [pyo3::Python::attach()].
    ///
    /// This function is just a wrapper around [pyo3::Python::attach()].
...
/**
```rust
use pytaurix::standalone::{dunce::simplified, PythonInterpreterEnv};
