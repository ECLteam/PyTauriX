...
- [#54](https://github.com/pytauri/pytauri/pull/54) - feat: export the extension module to `sys.modules["__pytaurix_ext_mod__"]` if on standalone mode.
- [#52](https://github.com/pytauri/pytauri/pull/52) - feat: set `sys._pytaurix_standalone=True` when run on standalone app (i.e., launch from rust).
...
[0.8.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.8.0
[0.7.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.7.0
[0.6.1]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.6.1
[0.6.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.6.0
[0.5.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.5.0
[0.4.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.4.0
[0.3.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.3.0
[0.2.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.2.0
[0.1.0-beta.0]: https://github.com/ECLteam/PyTauriX/releases/tag/rs/pytaurix/v0.1.0-beta.0
