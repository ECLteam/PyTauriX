...
use crate::{ext_mod::plugin::Plugin, pytaurix_plugins, tauri_runtime::Runtime, utils::TauriError};
...
impl From<PluginError> for PyErr {
    fn from(value: PluginError) -> Self {
        match value.0 {
            ...
            plugin::Error::FsError(e) => pytaurix_plugins::fs::PluginError::from(e).into(),
