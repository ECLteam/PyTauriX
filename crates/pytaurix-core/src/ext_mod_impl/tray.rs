...
impl TrayIcon {
    ...
    fn on_menu_event(&self, py: Python<'_>, handler: Py<PyAny>) {
    ...
    fn set_tooltip(&self, py: Python<'_>, tooltip: Option<&str>) -> PyResult<()> {
        py.detach(|| delegate_inner!(self, set_tooltip, tooltip))
    }
    ...
    fn set_visible(&self, py: Python<'_>, visible: bool) -> PyResult<()> {
        py.detach(|| delegate_inner!(self, set_visible, visible))
    }
    ...
    fn set_temp_dir_path(&self, py: Python<'_>, path: Option<PathBuf>) -> PyResult<()> {
        py.detach(|| delegate_inner!(self, set_temp_dir_path, path))
    }

    fn set_icon_as_template(&self, py: Python<'_>, is_template: bool) -> PyResult<()> {
        py.detach(|| delegate_inner!(self, set_icon_as_template, is_template))
    }

    fn set_show_menu_on_left_click(&self, py: Python<'_>, enable: bool) -> PyResult<()> {
        py.detach(|| delegate_inner!(self, set_show_menu_on_left_click, enable))
    }

    fn rect(&self, py: Python<'_>) -> PyResult<Option<Rect>> {
        let rect = py.detach(|| delegate_inner!(self, rect,))?;
        match rect {
