...
!!! bug
    ...
    [PythonInterpreterEnv::Venv]: https://docs.rs/pytaurix/latest/pytaurix/standalone/enum.PythonInterpreterEnv.html#variant.Venv
    [/absolute/path/to/.venv/]: https://github.com/ECLteam/PyTauriX/blob/10206e89f4925b35569c93d6797bfd401dea267b/examples/tauri-app/src-tauri/src/main.rs#L19-L33
"""

from pytaurix.plugins.deep_link.ffi import (
    init,
)
