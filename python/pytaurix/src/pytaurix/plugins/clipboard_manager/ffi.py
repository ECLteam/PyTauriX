...
if PLUGIN_CLIPBOARD_MANAGER:
    _clipboard_manager_mod: ModuleType = _pytaurix_plugins_mod.clipboard_manager
else:
    raise ImportError(
        "Enable the `plugin-clipboard-manager` feature for `pytaurix` crate to use this plugin."
    )
