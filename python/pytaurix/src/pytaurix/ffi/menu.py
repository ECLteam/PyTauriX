...
if TYPE_CHECKING:
    ...
    from pytaurix.ffi.lib import AppHandle, ImplManager, PositionType
    from pytaurix.ffi.window import Window
    ...
    class Menu:
        ...
        def remove_at(self, position: int, /) -> MenuItemKind | None: ...
        def get(self, id: MenuID, /) -> MenuItemKind | None: ...  # noqa: A002
    ...
    class PredefinedMenuItem:
        ...
        @staticmethod
        def copy(
            manager: ImplManager, text: str | None = None, /
        ) -> PredefinedMenuItem: ...
        @staticmethod
        def cut(
            manager: ImplManager, text: str | None = None, /
        ...
        def about(
            manager: ImplManager,
            text: str | None = None,
            metadata: AboutMetadata | None = None,
            /,
        ) -> PredefinedMenuItem: ...
        @staticmethod
        def services(
    ...
    class AboutMetadata:
        ...
        def __new__(
            ...
            *,
            ...
            credits: str | None = None,  # noqa: A002
    ...
    class IconMenuItem:
        ...
        def with_native_icon(
            ...
            text: str,
            enabled: bool,
            native_icon: NativeIcon | None = None,
            accelerator: str | None = None,
            /,
        ) -> IconMenuItem: ...
        @staticmethod
        ...
        def set_native_icon(self, native_icon: NativeIcon | None, /) -> None: ...
...
MenuItemKind = TypeAliasType(
    "MenuItemKind",
    MenuItem | Submenu | PredefinedMenuItem | CheckMenuItem | IconMenuItem,
)
"""[tauri::menu::MenuItemKind](https://docs.rs/tauri/latest/tauri/menu/enum.MenuItemKind.html)"""

ImplContextMenu = TypeAliasType("ImplContextMenu", Menu | Submenu)
