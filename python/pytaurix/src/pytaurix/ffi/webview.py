...
from pytaurix.ffi._typing import Pyo3PathInto, PySerdeFrom
...
_webview_mod = pytaurix_mod.webview
...
if TYPE_CHECKING:
    ...
    from pytaurix.ffi.menu import ImplContextMenu, Menu, MenuEvent
    from pytaurix.ffi.window import (
        Effects,
        Monitor,
        ProgressBarState,
        TitleBarStyle,
    ...
    class WebviewWindow:
        ...
        def request_user_attention(
            self, attention_type: UserAttentionType | None, /
        ) -> None: ...
        ...
        def set_effects(self, effects: Effects | None, /) -> None: ...
        ...
        def set_background_color(self, color: Color | None, /) -> None: ...
        ...
        if sys.platform == "win32":
            ...
            def set_overlay_icon(self, icon: Image | None, /) -> None: ...
...
class Cookie(TypedDict, closed=True):
    ...
    key: str
    value: str
    max_age: NotRequired[int | None]
    expires: NotRequired[datetime.datetime | None]
    path: NotRequired[str | None]
    domain: NotRequired[str | None]
    secure: NotRequired[bool | None]
    httponly: NotRequired[bool | None]
    samesite: NotRequired[SameSite | None]
    partitioned: NotRequired[bool | None]
