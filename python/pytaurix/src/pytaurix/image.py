...
from pytaurix.ffi.image import Image as _Image
...
class Image(_Image):
    ...
    @classmethod
    def from_bytes(cls, bytes_: bytes | bytearray | memoryview, /) -> Self:
        """Create an image from bytes.

        This method calls [pytaurix.image.Image.from_pil][] internally.
        """
        return cls.from_pil(PILImage.open(BytesIO(bytes_)))

    @classmethod
    def from_path(cls, path: str | bytes | PathLike[str] | PathLike[bytes], /) -> Self:
