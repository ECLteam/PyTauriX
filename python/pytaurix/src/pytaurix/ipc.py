...
from pytaurix._gen_ts import CommandInputOutput, InputOutput, NoneType, gen_ts
from pytaurix.ffi.ipc import (
    ArgumentsType,
    Headers,
    Invoke,
    InvokeResolver,
...
from pytaurix.ffi.ipc import Channel as _FFIChannel
from pytaurix.ffi.ipc import JavaScriptChannelId as _FFIJavaScriptChannelId
from pytaurix.ffi.lib import (
    AppHandle,
    _InvokeHandlerProto,  # pyright: ignore[reportPrivateUsage]
)
from pytaurix.ffi.webview import Webview, WebviewWindow
...
_WrappablePyHandlerType = Callable[..., Awaitable[bytes | BaseModel | Any]]
...
class InvokeException(Exception):  # noqa: N818
    ...
    pytaurix will return it to the frontend through `Invoke.reject(value)`
...
def _type_to_model(type_: Any) -> _ModelSerde[_T, RootModel[_T]]:
    ...
    if _type_to_model_inner.cache_info().misses > 128:
        warn(
            ...
            "please report this to pytaurix developers",
            stacklevel=2,
        )
    return model_serde
...
class Commands(UserDict[str, _PyInvokHandleData]):
    ...
    Typically, you would use [Commands.command][pytaurix.Commands.command] to register a command handler function.
    Then, use [Commands.generate_handler][pytaurix.Commands.generate_handler] to get an `invoke_handler`
    for use with [BuilderArgs][pytaurix.BuilderArgs].
    """

    _experimental_gen_ts: CommandInputOutput | None
    ...
    def __init__(self, *, experimental_gen_ts: bool = False) -> None:  # noqa: D107
        ...
        async def _async_invoke_handler(invoke: Invoke) -> None:
            ...
            try:
                ...
                resolver: InvokeResolver[ResolvedArgumentsType] | None = invoke.bind_to(
                    parameters
                )
                if resolver is None:
                ...
                msg = f"{_async_invoke_handler} implementation raised an exception, please report this as a pytaurix bug"
    ...
    def generate_handler(self, portal: BlockingPortal, /) -> _InvokeHandlerProto:
        ...
        You can use this method to get `invoke_handler` for use with [BuilderArgs][pytaurix.BuilderArgs].
    ...
    def wrap_pyfunc(  # noqa: C901, PLR0912, PLR0915  # TODO: simplify this method
        self, pyfunc: _WrappablePyHandlerType, *, _gen_ts_cmd: str | None = None
    ) -> _PyHandlerType:
        ...
        """
        serializer: _Serializer[BaseModel | Any] | None = None
        deserializer: _Deserializer[BaseModel | Any] | None = None
        input_type = NoneType
    ...
    def parse_parameters(pyfunc: _PyHandlerType, /) -> ParametersType:
        ...
        Check if the [Signature][inspect.Signature] of `pyfunc` conforms to [ArgumentsType][pytaurix.ipc.ArgumentsType],
        ...
        Returns:
            The parameters of the `pyfunc`. You can use it with [Invoke.bind_to][pytaurix.ipc.Invoke.bind_to].
        ...
        for name, param in parameters.items():
            # check if the `parameters` type hint conforms to [pytaurix.ipc.ArgumentsType][]
    ...
    def set_command(
        ...
        This method internally calls [parse_parameters][pytaurix.Commands.parse_parameters]
        and [wrap_pyfunc][pytaurix.Commands.wrap_pyfunc], `parse_parameters(wrap_pyfunc(handler))`.
        """
    ...
    def command(
        ...
        This method internally calls [set_command][pytaurix.Commands.set_command],
        which means the function signature must conform to [ArgumentsType][pytaurix.ipc.ArgumentsType].
        ...
        Raises:
            ValueError: If a command with the same name already exists.
                If it's expected, use [set_command][pytaurix.Commands.set_command] instead.
        """
        if command is None:
    ...
    async def experimental_gen_ts(
        ...
        json2ts_cmd: str,
        *,
        cmd_alias: Callable[[str], str] | None = to_camel,
    ) -> None:
    ...
    async def experimental_gen_ts_background(
        ...
        *,
        ...
        See [experimental_gen_ts][pytaurix.ipc.Commands.experimental_gen_ts] for more details.
...
class JavaScriptChannelId(
    ...
    """This class is a wrapper around [pytaurix.ffi.ipc.JavaScriptChannelId][].

    You can use this class as model field in pydantic model directly, or use it as model directly.

    > [pytaurix.ffi.ipc.JavaScriptChannelId][] can't be used directly in pydantic model.
    ...
    from pytaurix.ipc import JavaScriptChannelId, WebviewWindow
    ...
    def from_str(cls, value: str, /) -> Self:
        """See [pytaurix.ffi.ipc.JavaScriptChannelId.from_str][]."""
    ...
    def channel_on(self, webview: Webview, /) -> "Channel[_ModelTypeVar]":
        """See [pytaurix.ffi.ipc.JavaScriptChannelId.channel_on][]."""
        ffi_channel = self.root.channel_on(webview)
        return Channel(ffi_channel)


class Channel(Generic[_ModelTypeVar]):
    """This class is a wrapper around [pytaurix.ffi.ipc.Channel][].

    It adds the following methods:

    - [send_model][pytaurix.ipc.Channel.send_model]

    # Examples

    See [JavaScriptChannelId][pytaurix.ipc.JavaScriptChannelId--examples]
    """
