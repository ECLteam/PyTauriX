...
**[YANKED]: <https://github.com/ECLteam/PyTauriX/issues/242>**
...
- [#182](https://github.com/pytauri/pytauri/pull/182) - feat!: debugging tutorial.
    ...
    Added `tauri::{IS_DEV, RESTART_EXIT_CODE, VERSION, webview_version}` for obtaining pytaurix runtime configuration.
...
- [#178](https://github.com/pytauri/pytauri/pull/178) - feat(plugin-api)!: remove `rawPyInvoke` and `Channel`.
    ...
    [Channel.send][pytaurix.ipc.Channel.send], [Invoke.resolve][pytaurix.ipc.Invoke.resolve] and [InvokeResolver.resolve][pytaurix.ipc.InvokeResolver.resolve] now can send `Union[bytes, str]`:
...
- [#160](https://github.com/pytauri/pytauri/pull/160) - feat!: integrate `plugin-notification` as a gated-feature of `pytaurix`.

    Added: `pytaurix.plugins::notification::NotificationBuilderArgs`.
...
- [#141](https://github.com/pytauri/pytauri/pull/141) - feat!: `pytaurix.path.PathResolver` now returns a `pathlib.Path` object instead of a `str`.
- [#133](https://github.com/pytauri/pytauri/pull/113) - fix(pytaurix)!: make `BuilderArgs.invoke_handler` as required parameter for #110.
...
- [#62](https://github.com/WSH032/pytaurix/pull/62) - feat: add `path::PathResolver`, `Manager::path`.
- [#61](https://github.com/WSH032/pytaurix/pull/61) - feat: add `Emitter`, `EventTarget`, `EventTargetType`, `ImplEmitter` for [Event System](https://tauri.app/develop/calling-frontend/#event-system).
...
- [#54](https://github.com/pytauri/pytauri/pull/54)
    - feat: import the extension module from `sys.modules["__pytaurix_ext_mod__"]` if on standalone mode (`sys._pytaurix_standalone`).
    - feat: support specifying `entry_point` package name which be used to import the extension module via `os.environ["_PYTAURIX_DIST"]` (only for non-standalone mode).

## [0.1.0-beta.0]

[unreleased]: https://github.com/ECLteam/PyTauriX/tree/HEAD
[0.8.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.8.0
[0.7.2]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.7.2
[0.7.1]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.7.1
[0.7.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.7.0
[0.6.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.6.0
[0.5.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.5.0
[0.4.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.4.0
[0.3.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.3.0
[0.2.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.2.0
[0.1.0-beta.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix/v0.1.0-beta.0
