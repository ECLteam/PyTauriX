...
- [#265](https://github.com/pytauri/pytauri/pull/265) - feat(pytaurix): add `WebviewWindowBuilder` bindings.
    ...
    Enabled `pytaurix/tauri-macos-private-api` feature.

- [#259](https://github.com/pytauri/pytauri/pull/259) - feat(pytaurix): more `WebviewWindow` and `AppHandle` bindings.

    Enabled `pytaurix/tauri-devtools` feature.

- [#220](https://github.com/pytauri/pytauri/pull/220) - feat: support registering plugin from python.

    Enabled following pytaurix plugin features:
...
- [#165](https://github.com/pytauri/pytauri/pull/165) - feat: enable `tauri-plugin-notification` and integrate `pytaurix.plugins`.
...
[0.8.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix-wheel/v0.8.0
[0.7.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix-wheel/v0.7.0
[0.6.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix-wheel/v0.6.0
[0.5.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix-wheel/v0.5.0
[0.4.0]: https://github.com/ECLteam/PyTauriX/releases/tag/py/pytaurix-wheel/v0.4.0
